...
**If you find a security issue, do not open a public GitHub issue. Read [SECURITY.md](/docs/contributing/security).**
...
If you discover a security vulnerability, follow the responsible disclosure process in [SECURITY.md](/docs/contributing/security).
...
- **Security issues:** See [SECURITY.md](/docs/contributing/security) — do not open a public issue
